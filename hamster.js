...
request('http://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag&q=hamsters'
, function(error, response, body) {
  if (!error && response.statusCode == 200) {
    ...
    var url_array = data_array.map(function(gif_hash) {
      return 'http://api.giphy.com/v1/stickers/search?q=' + gif_hash + '&api_key=dc6zaTOxFJmzC'
